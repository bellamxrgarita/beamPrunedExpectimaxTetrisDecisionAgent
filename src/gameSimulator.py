...
def run_all_tests(agentType: str):
    ...
    agentType must be one of: "beamSearch", "expectimax", "beamPrunedExpectimaxAgent".
    """
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        print("Usage: python agentTester.py [beamSearchChance|expectimax|beamPrunedExpectimax]")
        sys.exit(1)
